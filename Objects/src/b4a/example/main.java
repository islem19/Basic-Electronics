...
vis = vis | (resistor.mostCurrent != null);
vis = vis | (inductor.mostCurrent != null);
vis = vis | (opamp.mostCurrent != null);
vis = vis | (opamp1.mostCurrent != null);
vis = vis | (opampinfo.mostCurrent != null);
vis = vis | (amplifier.mostCurrent != null);
return vis;}
public static String  _activity_create(boolean _firsttime) throws Exception{
 //BA.debugLineNum = 29;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 31;BA.debugLine="Activity.LoadLayout(\"Main\")";
mostCurrent._activity.LoadLayout("Main",mostCurrent.activityBA);
 //BA.debugLineNum = 32;BA.debugLine="Spinner1.AddAll(Array As String (\"Resistance/inductance\",\"Operational Amplifier\"))";
mostCurrent._spinner1.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Resistance/inductance","Operational Amplifier"}));
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 43;BA.debugLine="If Spinner1.SelectedIndex = 0 Then StartActivity(\"Resistor\")";
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("Resistor"));};
 //BA.debugLineNum = 44;BA.debugLine="If Spinner1.SelectedIndex = 1 Then StartActivity(\"opamp\")";
...
resistor._process_globals();
inductor._process_globals();
opamp._process_globals();
opamp1._process_globals();
opampinfo._process_globals();
amplifier._process_globals();
